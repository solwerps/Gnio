...
/**
 * GET /api/retenciones/isr?empresaId=5&fecha=YYYY-MM
...
export async function GET(req: NextRequest) {
  try {
    ...
    const rows = await prisma.isrRetencion.findMany({
      where,
