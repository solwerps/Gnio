// src/app/dashboard/contador/[usuario]/nomenclatura/[id]/page.tsx
"use client";
...
// Incrementa string numérico preservando longitud (120801 -> 120802)
...
// Duplicados por número de cuenta
...
export default function NomenclaturaDetalleContadorPage() {
    ...
    (async () => {
      ...
      try {
        ...
        const normalizadas: CuentaRow[] = list.map((r: any, i: number) => ({
          ...
          debeHaber: toPretty(r.debeHaber || "DEBE") as "DEBE" | "HABER",               // UI pretty
          principalDetalle: toPretty(r.principalDetalle || "P") as "P" | "D",            // UI pretty
          nivel: Number(r.nivel ?? 1),
          tipo: toPretty(r.tipo || "BALANCE_GENERAL") as Tipo,                           // UI pretty
          naturaleza: toPretty(r.naturaleza || "REVISAR") as Naturaleza,                 // UI pretty
          ...
          lockDelete:
            typeof r.lockDelete === "boolean"
              ? r.lockDelete
              : (r.isPlantilla ? true : !!r.lockRowActions),
        }));
  ...
  // Forzar expansión de la raíz a la que pertenece la nueva cuenta
  ...
  const addAfter = (r: CuentaRow) => {
    ...
    setRows(prev => {
      ...
      const nueva: any = {
        ...
        descripcion: "",               // libre
        debeHaber: r.debeHaber,        // hereda (UI pretty)
        principalDetalle: "D",
        ...
        _leadingRoot: parentLeading,   // para validar edición de cuenta
      };
  ...
  // ====== Guardar (PUT) con verificación de duplicados ======
